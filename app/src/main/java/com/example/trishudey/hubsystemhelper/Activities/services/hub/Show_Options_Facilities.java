...
public class Show_Options_Facilities extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show__options__facilities);
        Intent intent = getIntent();
        String data = intent.getStringExtra("facility");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_show__options__facilities, menu);
        return true;
    }
